...
const heroSlides = [
  {
    ...
    headline: "Architecting Digital Ecosystems",
  },
  {
    image: "/digital-marketing-hero-2.jpg",
    label: "Marketing Innovation",
    headline: "Creativity Meets Intelligence",
  },
  {
    image: "/digital-marketing-hero-3.jpg",
    label: "Data & Analytics",
    headline: "Insight-Driven Performance",
  },
  {
  ...
  },
  {
    ...
    headline: "Future-Ready Infrastructure",
  },
]
...
const offerings = [
  ...
  },
  {
    ...
    tagline: "Attribution modeling. Conversion optimization. Journey analytics.",
  },
  {
    title: "AI & Digital Transformation",
    description:
      "We help brands integrate AI-driven tools and smart technologies that enhance personalization, forecasting, and operational efficiency. Transformation is not about adopting trends — it's about building future-ready infrastructure.",
    tagline: "Intelligence embedded at every layer.",
  },
  {
    ...
    tagline: "Every channel. One experience.",
  },
  {
        ...
        {heroSlides.map((slide, i) => (
          ...
          >
            ...
            <div className="absolute bottom-20 left-4 md:left-8">
              <p className="font-serif text-sm uppercase tracking-widest text-background/70 mb-2">
                {slide.label}
              </p>
      ...
      <section className="px-4 md:px-8 py-24 bg-background">
        <div className="max-w-5xl">
          ...
          <div className="max-w-3xl space-y-6">
            ...
            <p className="font-serif text-lg md:text-xl text-foreground/80 leading-relaxed">
              At Grittyflint, we build integrated digital ecosystems where strategy, creativity, data, and technology converge to drive measurable business outcomes.
            </p>
              ...
              >
                ...
                <div
                  className={`overflow-hidden transition-all duration-500 ${
                    expandedOffering === index ? "max-h-96 pb-8" : "max-h-0"
                  }`}
                >
      ...
      <section className="px-4 md:px-8 py-24 bg-background">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-serif text-lg text-foreground/70 mb-16 max-w-2xl">
            A selection of campaigns that turned digital infrastructure into measurable growth.
          </p>
      ...
      <section className="px-4 md:px-8 py-24 bg-foreground">
        <div className="max-w-4xl mx-auto text-center">
          <p className="font-sans text-3xl md:text-5xl font-black uppercase tracking-tight text-background leading-tight text-balance">
            ...
            <br />
            Digital drives infrastructure.
            <br />
            Data drives decisions.
          </p>
          <div className="mt-12 space-y-4 font-serif text-lg text-background/80">
            <p>We connect all three.</p>
            <p className="text-accent font-bold text-xl">
              Digital & Marketing isn{"'"}t a service. It{"'"}s a growth architecture.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="px-4 md:px-8 py-20">
        <div className="max-w-4xl mx-auto bg-accent p-12 rounded-lg">
          ...
          <p className="font-serif text-lg mb-8 text-accent-foreground/90">
            Let{"'"}s discuss how Grittyflint can build digital ecosystems that drive measurable business outcomes.
          </p>
          <a
            href="/contact"
