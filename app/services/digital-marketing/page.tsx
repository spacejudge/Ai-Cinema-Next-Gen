...
const heroSlides = [
  {
    ...
    headline: "Architect Your Digital Future",
  },
  {
    image: "/digital-marketing-hero-2.jpg",
    label: "Marketing Innovation",
    headline: "Creative Meets Intelligence",
  },
  {
    image: "/digital-marketing-hero-3.jpg",
    label: "Data & Analytics",
    headline: "Insight-Driven Growth",
  },
  {
...
const offerings = [
  ...
  },
  {
    ...
    tagline:
      "Transformation is not about adopting trends. It's about building future-ready infrastructure.",
  },
  {
        ...
        <div className="max-w-5xl">
          ...
          <div className="max-w-3xl space-y-6">
            <p className="font-serif text-lg md:text-xl text-foreground/80 leading-relaxed">
              Digital is no longer a channel. It is the infrastructure of modern
              brand growth. At Grittyflint, we build integrated digital
              ecosystems where strategy, creativity, data, and technology
              converge to drive measurable business outcomes.
            </p>
            <p className="font-serif text-lg md:text-xl text-foreground font-bold">
              We don{"'"}t just generate traffic. We design systems that convert
              it.
            </p>
          </div>
        </div>
            ...
            {offerings.map((offering, index) => (
              ...
              >
                <button
                  onClick={() =>
                    setExpandedOffering(
                      expandedOffering === index ? null : index
                    )
                  }
                  ...
                  {offering.bullets && (
                    <ul className="list-none space-y-2 mb-4">
                      {offering.bullets.map((bullet) => (
                        <li
                          key={bullet}
                          className="font-serif text-background/70 flex items-center gap-3"
                        >
      ...
      <section className="px-4 md:px-8 py-24 bg-background">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="font-serif text-lg text-foreground/70 mb-16 max-w-2xl">
            A selection of campaigns that turned digital intelligence into
      ...
      <section className="px-4 md:px-8 py-24 bg-foreground">
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-2 mb-12">
            <p className="font-sans text-3xl md:text-5xl font-black uppercase tracking-tight text-background leading-tight">
          ...
          <p className="font-serif text-2xl text-accent font-bold mb-8">
            We connect all three.
          </p>
          <div className="space-y-4 font-serif text-lg text-background/80">
            <p>
              At Grittyflint, Digital & Marketing isn{"'"}t a service.
            </p>
      ...
      <section className="px-4 md:px-8 py-20">
        <div className="max-w-4xl mx-auto bg-accent p-12 rounded-lg">
          ...
          <p className="font-serif text-lg mb-8 text-accent-foreground/90">
            Let{"'"}s discuss how Grittyflint can build digital systems that
            convert attention into measurable business outcomes.
          </p>
          <a
            href="/contact"
